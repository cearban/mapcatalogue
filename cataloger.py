...
def main():
    #fn = '/home/james/geocrud/wms_getmaps/wms_list.csv'
    #interrogate_wms_layers(fn)
    for fn in glob.glob('/home/james/geocrud/wms_getmaps/*.png'):
        status = check_wms_map_image(fn)
        print(fn, status)
